...
//    }
    ...
    @Test
    public void KKadinsure_110106_MTS() throws Exception {
        String steps = kktest.converter(generatedString,"110106_MTS.xml", environment);
        System.out.println("Steps are: \n" + steps);
        checkValues(steps, "10");
        checkValues(steps, "20");
        checkValues(steps, "30");
    ...
    @Test
    public void KKadinsure_110106_TELE2() throws Exception {
        String steps = kktest.converter(generatedString,"110106_TELE2.xml", environment);
        System.out.println("Steps are: \n" + steps);
        checkValues(steps, "10");
        checkValues(steps, "20");
        checkValues(steps, "XSLT error");
    }

    @Test
    public void KKadinsure_70001_new() throws Exception {
        String steps = kktest.converter(generatedString,"70001_new.xml", environment);
        System.out.println("Steps are: \n" + steps);
        checkValues(steps, "10");
        checkValues(steps, "20");
        checkValues(steps, "30");
    ...
    @Test
    public void KKadinsure_70101_new() throws Exception {
        String steps = kktest.converter(generatedString,"70101_new.xml", environment);
        System.out.println("Steps are: \n" + steps);
        checkValues(steps, "10");
        checkValues(steps, "20");
        checkValues(steps, "30");
